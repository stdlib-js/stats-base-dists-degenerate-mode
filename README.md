...
```javascript
import mode from 'https://cdn.jsdelivr.net/gh/stdlib-js/stats-base-dists-degenerate-mode@v0.3.1-deno/mod.js';
```
...
[test-image]: https://github.com/stdlib-js/stats-base-dists-degenerate-mode/actions/workflows/test.yml/badge.svg?branch=v0.3.1
[test-url]: https://github.com/stdlib-js/stats-base-dists-degenerate-mode/actions/workflows/test.yml?query=branch:v0.3.1
